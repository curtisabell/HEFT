...
pypl.plot(L, H0_eigs[:,0], color='blue', linestyle='dashdot')
...
# pypl.title('$\Lambda_v$ = %i MeV, $g_{\Delta}=0.235$' % (Lambda*1000))
...
# pypl.title('With Bare $\Delta$')
# savefig('1b1c_EvL_08GeV.pdf', bbox_inches='tight')

# pypl.title('$\Lambda = %.2f$ GeV' % Lambda)
# pypl.title('Finite-volume energy spectrum')

outFile = f'figs/1b1c_EvL_fit{fitNum}.pdf'
